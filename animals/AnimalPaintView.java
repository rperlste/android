...
public class AnimalPaintView extends View 
{
   ...
   public AnimalPaintView(Context context, AttributeSet attrs) 
   {
   ...
   public void onSizeChanged(int w, int h, int oldW, int oldH)
   {
      ...
      //Setting changed to make sure the anaimal was visible
